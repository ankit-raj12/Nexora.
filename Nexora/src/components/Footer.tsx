...
export default function Footer() {
  return (
    <footer className="bg-neu-base relative overflow-hidden py-8 px-4 md:px-8 border-t border-slate-200">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
        ...
        <motion.div
          ...
          className="flex flex-col sm:flex-row gap-4 md:gap-8 items-center"
        >
          <a
            href="tel:+917654954462"
            className="flex items-center gap-2 text-gray-600 hover:text-[#667eea] transition-colors group"
          >
            <div className="w-8 h-8 rounded-full neu-button flex items-center justify-center text-gray-500 group-hover:text-[#667eea]">
              <Phone size={14} />
            </div>
      ...
      <motion.div 
        ...
        className="text-center mt-8 pt-6 border-t border-slate-200/50"
      >
